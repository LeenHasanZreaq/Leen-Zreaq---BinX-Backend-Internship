...
{
    public async Task<string> GetUserProfileAsync1(string userId)
    {
    ...
    public async Task<string> GetOrderHistoryAsync1(string userId)
    {
        await Task.Delay(2000);
    ...
    public static async Task Main(string[] args)
    {
        ...
        Task<string> profileTask = service.GetUserProfileAsync("101");
        Task<string> ordersTask = service.GetOrderHistoryAsync("101");
        Task<string> friendsTask = service.GetFriendsListAsync("101");



        await Task.WhenAll(profileTask, ordersTask, friendsTask);

        Console.WriteLine(profileTask.Result);
        Console.WriteLine(ordersTask.Result);
        Console.WriteLine(friendsTask.Result);
    ...
    public async Task<string> GetFriendsListAsync(string userId)
    {
        await Task.Delay(2000);
