...
### API purpose
The Day 5 work implements a simple Books CRUD API for a small bookstore demo. The resource is exposed through the Books controller and uses JSON payloads.
...
## 3. Postman artifacts
- Collection: [week_3/Day4/Postman/Week_3_Day_5_Books_API.postman_collection.json](week_3/Day4/Postman/Week_3_Day_4_Books_API.postman_collection.json)
- Environment: [week_3/Day4/Postman/Week_3_Day_5_Books_API.postman_environment.json](week_3/Day4/Postman/Week_3_Day_4_Books_API.postman_environment.json)
